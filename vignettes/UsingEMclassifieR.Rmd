...
for (i in nrow(matTable)){
  ...
  runEMrangeClassNum(data, k_range, convergenceError, maxIterations,
                     repeats=numRepeats, outPath=outPath, xlim=xlim, 
                     outFileBase=paste(sampleName, regionName, sep="_"),
                     doIndividualPlots=TRUE)

           
           
  plotCusteringMetrics(data, k_range, maxB, convergenceError,
