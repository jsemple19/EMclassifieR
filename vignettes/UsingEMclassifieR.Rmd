...
xRange=c(-250,250)
maxB=50 # Number of randomised matrices to generate
outPath="./EMres_multigene_test1"
maxTasks=4
taskId=1
nThreads=4
setSeed=FALSE
#distMetric=list(name="cosineDist",val0=0,rescale=F)
#distMetric=list(name="canberraDist",rescale=T)
distMetric=list(name="correlationDist",val0=0.5,rescale=T)
##distMetric=list(name="euclidean",val0=0.5,rescale=T)
...
distMetric=list(name="cosineDist",rescale=T) #list(name="euclidean")
